import usePopUpByErrorFunctions from '../hooks/usePopUpByErrorFunctions';
...
export const popUpDataByError: Record<ErrorTypes, IPopDataByError> = {
...
export default popUpDataByError;
